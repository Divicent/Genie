    ...
    public partial class BaseQueryContext : BaseQueryContextBase
    {
        ...
        public virtual string TransformText()
        {
            ...
            this.Write(".Infrastructure.Models.Concrete.Context\r\n{\r\n    public abstract class BaseQueryCo" +
                    ...
                    "                              break;\r\n                        }\r\n               " +
                    "         break;\r\n                    default:\r\n                        continue;" +
                    "\r\n                }\r\n\r\n\t\t        if (qotd == true && propertyFilter.Value.ToStri" +
                    "ng() == \"true\" || propertyFilter.Value.ToString() == \"false\")\r\n\r\n\t\t        \r\n   " +
                    "             queue.Enqueue(\"and\");\r\n\t\t        queue.Enqueue(GetExpression(proper" +
                    "tyFilter.Type, propName, propertyFilter.Value,\r\n\t\t            qotd.GetValueOrDef" +
                    "ault()));\r\n\t\t    }\r\n\t\t}\r\n\r\n        private static string GetExpression(string ty" +
                    "pe, string propName, object value, bool quoted )\r\n        {\r\n            switch " +
                    "(type.ToLower())\r\n            {\r\n                case \"equals\":\r\n               " +
                    " case \"eq\":\r\n                    return QueryMaker.EqualsTo(propName, value, quo" +
                    "ted);\r\n                case \"notequals\":\r\n                case \"neq\":\r\n         " +
                    "       case \"ne\":\r\n                    return QueryMaker.NotEquals(propName, val" +
                    "ue, quoted);\r\n                case \"contains\":\r\n                case \"c\":\r\n     " +
                    "               return QueryMaker.Contains(propName, value);\r\n                cas" +
                    "e \"notcontains\":\r\n                case \"nc\":\r\n                    return QueryMa" +
                    "ker.NotContains(propName, value);\r\n                case \"startswith\":\r\n         " +
                    "       case \"sw\":\r\n                    return QueryMaker.StartsWith(propName, va" +
                    "lue);\r\n                case \"notstartswith\":\r\n                case \"nsw\":\r\n     " +
                    "               return QueryMaker.NotStartsWith(propName, value);\r\n              " +
                    "  case \"endswith\":\r\n                case \"ew\":\r\n                    return Query" +
                    "Maker.EndsWith(propName, value);\r\n                case \"notendswith\":\r\n         " +
                    "       case \"new\":\r\n                    return QueryMaker.NotEndsWith(propName, " +
                    "value);\r\n                case \"isempty\":\r\n                case \"ie\":\r\n          " +
                    "          return QueryMaker.IsEmpty(propName);\r\n                case \"isnotempty" +
                    "\":\r\n                case \"ino\":\r\n                    return QueryMaker.IsNotEmpt" +
                    "y(propName);\r\n                case \"isnull\":\r\n                case \"in\":\r\n      " +
                    "              return QueryMaker.IsNull(propName);\r\n                case \"isnotnu" +
                    "ll\":\r\n                case \"inn\":\r\n                    return QueryMaker.IsNotNu" +
                    "ll(propName);\r\n                case \"greaterthan\":\r\n                case \"gt\":\r\n" +
                    "                    return QueryMaker.GreaterThan(propName, value, quoted);\r\n   " +
                    "             case \"lessthan\":\r\n                case \"lt\":\r\n                    r" +
                    "eturn QueryMaker.LessThan(propName, value, quoted);\r\n                case \"great" +
                    "erthanorequals\":\r\n                case \"gtoe\":\r\n                case \"gte\":\r\n   " +
                    "                 return QueryMaker.GreaterThanOrEquals(propName, value, quoted);" +
                    "\r\n                case \"lessthanorequals\":\r\n                case \"ltoe\":\r\n      " +
                    "          case \"lte\":\r\n                    return QueryMaker.LessThanOrEquals(pr" +
                    "opName, value, quoted);\r\n                case \"istrue\":\r\n                case \"i" +
