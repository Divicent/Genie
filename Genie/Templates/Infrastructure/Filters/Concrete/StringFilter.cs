...
#line hidden
        ...
        public virtual string TransformText()
        {
            ...
            this.Write(".Infrastructure.Filters.Concrete\r\n{\r\n    public class StringFilter<T, TQ> : IStri" +
                    ...
                    "         return new ExpressionJoin<T, TQ>(_parent, _q);\r\n        }\r\n\r\n        pu" +
                    "blic IExpressionJoin<T, TQ> StartsWith(string str)\r\n        {\r\n            _pare" +
                    "nt.Add(QueryMaker.StartsWith(_propertyName, Prepare(str)));\r\n            return " +
                    "new ExpressionJoin<T, TQ>(_parent, _q);\r\n        }\r\n\r\n        public IExpression" +
                    "Join<T, TQ> NotStartsWith(string str)\r\n        {\r\n            _parent.Add(QueryM" +
                    "aker.NotStartsWith(_propertyName, Prepare(str)));\r\n            return new Expres" +
                    "sionJoin<T, TQ>(_parent, _q);\r\n        }\r\n\r\n        public IExpressionJoin<T, TQ" +
                    "> EndsWith(string str)\r\n        {\r\n            _parent.Add(QueryMaker.EndsWith(_" +
                    "propertyName, Prepare(str)));\r\n            return new ExpressionJoin<T, TQ>(_par" +
                    "ent, _q);\r\n        }\r\n\r\n        public IExpressionJoin<T, TQ> NotEndsWith(string" +
                    " str)\r\n        {\r\n            _parent.Add(QueryMaker.NotEndsWith(_propertyName, " +
                    "Prepare(str)));\r\n            return new ExpressionJoin<T, TQ>(_parent, _q);\r\n   " +
                    "     }\r\n\r\n        public IExpressionJoin<T, TQ> IsEmpty()\r\n        {\r\n          " +
                    "  _parent.Add(QueryMaker.IsEmpty(_propertyName));\r\n            return new Expres" +
                    "sionJoin<T, TQ>(_parent, _q);\r\n        }\r\n\r\n        public IExpressionJoin<T, TQ" +
                    "> IsNotEmpty()\r\n        {\r\n            _parent.Add(QueryMaker.IsNotEmpty(_proper" +
                    "tyName));\r\n            return new ExpressionJoin<T, TQ>(_parent, _q);\r\n        }" +
