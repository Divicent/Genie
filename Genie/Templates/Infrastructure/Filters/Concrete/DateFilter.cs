...
#line hidden
        ...
        public virtual string TransformText()
        {
            ...
            this.Write(".Infrastructure.Filters.Concrete\r\n{\r\n    public class DateFilter<T, TQ> : IDateFi" +
                    ...
                    "\r\n        {\r\n\t\t\t_parent.Add(isNull ? QueryMaker.IsNull(_propertyName) : QueryMak" +
                    "er.IsNotNull(_propertyName));\r\n\t\t\treturn new ExpressionJoin<T, TQ>(_parent, _q);" +
                    "\r\n        }\r\n\r\n        public IExpressionJoin<T, TQ> In(params DateTime[] items)" +
                    "\r\n        {\r\n            _parent.Add(QueryMaker.In(_propertyName, items.Cast<obj" +
                    "ect>().ToArray(), true));\r\n            return new ExpressionJoin<T, TQ>(_parent," +
                    " _q);\r\n        }\r\n\r\n        public IExpressionJoin<T, TQ> NotIn(params DateTime[" +
                    "] items)\r\n        {\r\n            _parent.Add(QueryMaker.NotIn(_propertyName, ite" +
                    "ms.Cast<object>().ToArray(), true));\r\n            return new ExpressionJoin<T, T" +
                    "Q>(_parent, _q);\r\n        }\r\n    }\r\n}\r\n");
