...
#line hidden
        ...
        public virtual string TransformText()
        {
            ...
            this.Write(".Infrastructure.Filters.Concrete\r\n{\r\n    public class NumberFilter<T, TQ> : INumb" +
                    ...
                    "ressionJoin<T, TQ>(_parent, _q);\r\n        }\r\n\r\n\t\tpublic IExpressionJoin<T, TQ> I" +
                    "sNull(bool isNull)\r\n        {\r\n\t\t\t_parent.Add(isNull ? QueryMaker.IsNull(_proper" +
                    "tyName) : QueryMaker.IsNotNull(_propertyName));\r\n\t\t\treturn new ExpressionJoin<T," +
                    " TQ>(_parent, _q);\r\n        }\r\n\r\n        public IExpressionJoin<T, TQ> In(params" +
                    " double[] items)\r\n        {\r\n            _parent.Add(QueryMaker.In(_propertyName" +
                    ", items.Cast<object>().ToArray(), false));\r\n            return new ExpressionJoi" +
                    "n<T, TQ>(_parent, _q);\r\n        }\r\n\r\n        public IExpressionJoin<T, TQ> NotIn" +
                    "(params double[] items)\r\n        {\r\n            _parent.Add(QueryMaker.NotIn(_pr" +
                    "opertyName, items.Cast<object>().ToArray(), false));\r\n            return new Exp" +
                    "ressionJoin<T, TQ>(_parent, _q);\r\n        }\r\n    } \r\n}\r\n");
